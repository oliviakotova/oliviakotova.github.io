          ...
          <div className="max-w-[1240px] mx-auto p-10 grid md:grid-cols-5 gap-8 py-20">
            <div className="col-span-4 space-y-5">
              ...
              <p>
                ...
                Having genuine interest in IT, began exploring deeply that area
                couple years ago to make a career change. Aiming to achieve
                sufficient foundation to become a professional I graduated at
                TAFE South Bank with Diploma in Web Development where I gained
                hands-on experience with JavaScript, ReactJS, NodeJS, Data
                Structures, APIs, SQL and non SQL (MongoDB) database, Bootstrap
                and tech principles and culture via both team/individual
                projects, code reviews and presentations. Looking to launch my
                career in tech after graduating. I believe my passion in solving
                complex tasks by applying modern IT solutions will be an asset
                to your company.
              </p>
            </div>
            ...
            <div className="col-span-4 space-y-5">
              ...
              <h4 className="text-[hsl(217,56%,45%)] pt-8">
                Graphic Designer and Retoucher at Koshka Media Pty Ltd (Sydney,
