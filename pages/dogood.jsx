    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-6 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This app was built using ReactJS,NodeJS and MongoDB is hosted on
            Heroku. Do good volunteering app is a platform where people in need
            can place their request of help and its details and volunteers who
            can see that list of tasks in their local and willing to provide
            help in their free time. User authentication is available so you can
            signup or signin to your account with an email address and found
            volunteers or people who need help. Users are able to search and
            have a look on profoles other users, message each other in real
            time.
          </p>
          <a
