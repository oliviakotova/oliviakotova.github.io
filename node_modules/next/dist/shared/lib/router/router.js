   ...
   */ replace(url, as, options = {}) {
     ...
     */ let route = requestedRoute;
            try {
                ...
                handleCancelled();
                if ((data == null ? void 0 : (ref6 = data.effect) == null ? void 0 : ref6.type) === 'redirect-internal' || (data == null ? void 0 : (ref4 = data.effect) == null ? void 0 : ref4.type) === 'redirect-external') {
                    return data.effect;
                }
       ...
       */ const useStreamedFlightData = routeInfo.__N_RSC && (process.env.NODE_ENV !== 'production' || routeInfo.__N_SSP);
                ...
                const { props  } = yield _this._getData(_async_to_generator(function*() {
                    if (shouldFetchData && !useStreamedFlightData) {
                        var ref;
                        const { json  } = (data == null ? void 0 : data.json) && ((ref = data == null ? void 0 : data.response.headers.get('content-type')) == null ? void 0 : ref.includes('application/json')) ? data : yield fetchNextData({
                            dataHref: _this.pageLoader.getDataHref({
                                href: (0, _formatUrl).formatWithValidation({
                                    pathname,
                                    query
